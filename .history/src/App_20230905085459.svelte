...
<Offcanvas end {isOpen} toggle={()=>isOpen=!isOpen} header="Sort Menu">
	...
	<Slider {...slider} label="Name" on:input={doSort} bind:id={sorters.append}/>
	<Slider {...slider} label="Last Active" on:input={doSort} bind:id={sorters.append}/>
	<Slider {...slider} label="BGG Rank" on:input={doSort} bind:id={sorters.append}/>
</Offcanvas>
