...
<Offcanvas end {isOpen} toggle={()=>isOpen=!isOpen} header="Sort Menu">
	...
	<Slider {...slider} label="Name" on:input={doSort} bind:input={sorters.name} />
	<Slider {...slider} label="Last Active" on:input={doSort} bind:input={sorters.latest}/>
	<Slider {...slider} label="BGG Rank" on:input={doSort} bind:input={sorters.rank}/>
</Offcanvas>
