<script>
		...
		async function getData() {
				try{
					...
					data=Object.values(json).slice(0,100)
					return json
...
<!-- -->
<Navbar color="primary" container sticky>
	<NavbarBrand>blaaa</NavbarBrand>
	<Nav>
		<NavItem  class="m-3 p-0"><Input bind:value={filter} bsSize="sm" color="secondary" /></NavItem>
